            ...
            <div className="relative rounded-[3rem] bg-[#0a0a0a] border border-accent/20 shadow-[0_0_50px_-12px_rgba(197,160,89,0.15)] overflow-hidden">
              ...
              <div className="relative p-10 md:p-16 lg:p-20 grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <button 
                    onClick={() => {
                      const whatsappMessage = encodeURIComponent(`Hello Crown Estate Realty, I would like to subscribe to your VIP Market Reports and Pre-launch alerts.`);
                      const whatsappUrl = `https://wa.me/919511811326?text=${whatsappMessage}`;
                      window.open(whatsappUrl, "_blank");
                    }}
                    className="inline-flex items-center justify-center gap-3 bg-accent text-black font-bold uppercase tracking-widest text-sm px-8 py-4 rounded-full hover:bg-white hover:scale-105 transition-all duration-300 cursor-pointer"
                  >
