      ...
      <main className="flex-1 pt-32 pb-10">
          ...
          <div className="max-w-5xl mx-auto text-center mt-12">
            ...
            <SlideUp delay={0.2}>
              <p className="text-lg md:text-xl text-zinc-400 leading-relaxed font-light max-w-3xl mx-auto">
                Crown Estate Realty is a private-office standard advisory firm.
              ...
              <SlideUp delay={0.2}>
                <div className="max-w-2xl">
                  ...
                  <p className="text-lg text-zinc-400 font-light leading-relaxed mb-6">
                    The NCR real estate market is incredibly dynamic, but it can also be overwhelming. We founded Crown Estate Realty with a singular mission: to cut through the market noise and offer a strictly advisory-led approach. No aggressive sales pitches, no hidden clauses—just data-backed insights and strict RERA compliance.
                  </p>
        ...
        <section className="relative py-24 border-t border-white/5">
          <Container>
            <SectionHeader
              align="center"
              eyebrow="The Crown Estate Standard"
